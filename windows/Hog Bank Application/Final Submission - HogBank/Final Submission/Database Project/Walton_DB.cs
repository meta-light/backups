        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=essql1.walton.uark.edu;Initial Catalog=Section2Team2_db;user id=Section2Team2;password=4283Pass3725C779##;Persist Security Info=False;";
                }
